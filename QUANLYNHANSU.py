...
def main():
    ...
    ttk.Label(tabNhanVien,text ="QUẢN LÝ NHÂN VIÊN",font = ("Times New Roman",20,'bold'),justify = tk.CENTER).grid(row=0,column=0,columnspan=7)

    ttk.Label(tabNhanVien,font=(15)).grid(row=1,column=0)
    
    lblFrame1 = ttk.Frame(tabNhanVien)
    ...
    ttk.Label(tabNhanVien,width=10).grid(row=2,column=1)

    stringMaNV = tk.StringVar()
    stringHoTenNV = tk.StringVar()
    intThamNien = tk.IntVar()

    Frame1 = ttk.Frame(tabNhanVien)
    ...
    ttk.Label(tabNhanVien,width=10).grid(row=2,column=3)

    
    lblFrame2 = ttk.Frame(tabNhanVien)
    ...
    ttk.Label(tabNhanVien,width=5).grid(row=2,column=5)
    
    Frame2 = ttk.Frame(tabNhanVien)
    ...
    FrameButton = ttk.Frame(tabNhanVien)
    ...
    ttk.Label(tabNhanVien,font = (15)).grid(row=4,column=0)
    ttk.Label(tabNhanVien,text = 'Danh sách nhân viên:',font = ('Times New Roman',15)).grid(row=5,column=0)

    columns = ('Mã nhân viên','Họ tên','CCCD','Điện thoại','Giới tính','Email','Ngày sinh','Phòng ban','Chức vụ','Thâm niên')
    tree = ttk.Treeview(tabNhanVien,columns = columns,show = "headings",height = 10)
    ...
    ttk.Label(tabHopDong,text = "QUẢN LÝ HỢP ĐỒNG",font = ('Times New Roman',20,'bold')).grid(row=0,column=0,columnspan=7)

    ttk.Label(tabHopDong,font = (10)).grid(row=1,column=0)

    lblFrameHD1 = ttk.Frame(tabHopDong)
    ...
    ttk.Label(tabHopDong,width=10).grid(row=2,column=1)

    FrameHD1 = ttk.Frame(tabHopDong)
    ...
    ttk.Label(tabHopDong,width=10).grid(row=2,column=3)

    lblFrameHD2 = ttk.Frame(tabHopDong)
    ...
    ttk.Label(tabHopDong,width=10).grid(row=2,column=5)

    FrameHD2 = ttk.Frame(tabHopDong)
    ...
    FrameButtonHD = ttk.Frame(tabHopDong)
    ...
    ttk.Label(tabHopDong,font = (15)).grid(row=4,column=0)
    ttk.Label(tabHopDong,text = 'Danh sách hợp đồng:',font = ('Times New Roman',15)).grid(row=5,column=0)

    columns = ("Mã hợp đồng","Loại hợp đồng","Ngày kí","Thời hạn","Mã nhân viên","Ngày bắt đầu","Ngày kết thúc","Lương cơ bản")
    treehd = ttk.Treeview(tabHopDong,columns = columns,show = "headings",height = 10)
    ...
    def select_item_hd(event):
        ...
        if selected_item:
            ...
            if values:
                ...
                luongcb_entryhd.insert(0,f"{float(values[7]):.1f}")
    ...
    ttk.Label(tabCongNgay,text = "CHẤM CÔNG NGÀY",font = ('Times New Roman',20,'bold')).grid(row=0,column=0,columnspan=7)

    ttk.Label(tabCongNgay,font = (10)).grid(row=1,column=0,columnspan=7)

    lblFrameCN1 = ttk.Frame(tabCongNgay)
    ...
    ttk.Label(tabCongNgay,width=10).grid(row=2,column=1)

    FrameCN1 = ttk.Frame(tabCongNgay)
    ...
    ttk.Label(tabCongNgay,width=10).grid(row=2,column=3)

    lblFrameCN2 = ttk.Frame(tabCongNgay)
    ...
    ttk.Label(tabCongNgay,width=10).grid(row=2,column=5)

    FrameCN2 = ttk.Frame(tabCongNgay)
    ...
    #tạo hàng nút
    FrameButtonCN = ttk.Frame(tabCongNgay)
    ...
    ttk.Label(tabCongNgay,font = (15)).grid(row=4,column=0)
    ttk.Label(tabCongNgay,text = 'Danh sách hợp đồng:',font = ('Times New Roman',15)).grid(row=5,column=0)
    ttk.Label(tabCongNgay,font=(10)).grid(row=6,column=0)

    #tạo danh sách chấm công ngày bằng treeview
    columns = ("Mã nhân viên","Ngày làm","Số giờ chính","Số giờ tăng ca")
    treecn = ttk.Treeview(tabCongNgay,columns = columns,show = "headings",height = 10)
    ...
    ttk.Label(tabLuong,text = "QUẢN LÝ LƯƠNG",font = ('Times New Roman',20,'bold')).grid(row=0,column=0,columnspan=7)

    ttk.Label(tabLuong,font = (10)).grid(row=1,column=0,columnspan=7)

    lblFrameLuong1 = ttk.Frame(tabLuong)
    ...
    ttk.Label(tabLuong,width=10).grid(row=2,column=1)

    FrameLuong1 = ttk.Frame(tabLuong)
    ...
    ttk.Label(tabLuong,width=10).grid(row=2,column=3)

    lblFrameLuong2 = ttk.Frame(tabLuong)
    ...
    ttk.Label(tabLuong,width=10).grid(row=2,column=5)

    FrameLuong2 = ttk.Frame(tabLuong)
    ...
    def tong_ket_luong():
            ...
            ((T.TONGGIOCHINH * HD.LUONGCB + T.TONGTANGCA * 1.5 * HD.LUONGCB) * 0.13 + 50000) 
            AS THUCNHAN

        FROM BangTongGio T
        JOIN NHANVIEN NV ON T.MANV = NV.MANV
        JOIN HOPDONG HD ON T.MANV = HD.MANV
        WHERE NOT EXISTS (
    ...
    #tạo nút
    FrameButtonLuong = ttk.Frame(tabLuong)
    ...
    ttk.Label(tabLuong,font = (10)).grid(row=4,column=0)

    ttk.Label(tabLuong,text = 'Danh sách:',font = ('Times New Roman',15)).grid(row=5,column=0,columnspan=7)

    ttk.Label(tabLuong,font = (10)).grid(row=6,column=0)

    #tạo danh sách chấm công ngày bằng treeview
    columns = ("Mã nhân viên","Tháng/Năm","Tổng giờ chính","Tổng giờ tăng ca","Tổng lương","Phụ cấp","Khấu trừ","Thực nhận")
    treeluong = ttk.Treeview(tabLuong,columns = columns,show = "headings",height = 10)
    ...
    def select_item_luong(event):
        ...
        if selected_item:
            ...
            if values:
                ...
                tongluong_entryluong.insert(0,f"{float(values[4]):.1f}")
                phucap_entryluong.insert(0,f"{float(values[5]):.1f}")
                khautru_entryluong.insert(0,f"{float(values[6]):.1f}")
                thucnhan_entryluong.insert(0,f"{float(values[7]):.1f}")
    ...
    ttk.Label(tabCT,text = "QUẢN LÝ LƯƠNG",font = ('Times New Roman',20,'bold')).grid(row=0,column=0,columnspan=11)

    ttk.Label(tabCT,font = (10)).grid(row=1,column=0,columnspan=11)

    lblFrame1 = ttk.Frame(tabCT)
    ...
    ttk.Label(tabCT,width=10).grid(row=2,column=1)

    Frame1 = ttk.Frame(tabCT)
    ...
    ttk.Label(tabCT,width=10).grid(row=2,column=3)

    lblFrame2 = ttk.Frame(tabCT)
    ...
    ttk.Label(tabCT,width=10).grid(row=2,column=5)

    Frame2 = ttk.Frame(tabCT)
    ...
    ttk.Label(tabCT,font = (10)).grid(row=2,column=7)

    lblFrame3 = ttk.Frame(tabCT)
    ...
    ttk.Label(tabCT,font = (10)).grid(row=2,column=9)

    Frame3 = ttk.Frame(tabCT)
    ...
    ttk.Label(tabCT,font = (10)).grid(row=3,column=0)
    ...
    ttk.Label(tabCT,font = (10)).grid(row=4,column=0)
    ttk.Label(tabCT,text = 'Danh sách chi tiết lương:',font = ('Times New Roman',15)).grid(row=5,column=0,columnspan=11)
    ttk.Label(tabCT,font = (10)).grid(row=6,column=0)
    ...
    treect = ttk.Treeview(tabCT,columns = columns,show = "headings",height = 10)
    ...
    def select_item_ct(event):
        ...
        if selected_item:
            ...
            if values:
                ...
                luongcb_entryct.insert(0, f"{float(values[2]):.1f}")     
                luongtc_entryct.insert(0,f"{float(values[3]):.1f}")
                tongluong_entryct.insert(0,f"{float(values[2])+float(values[3]):.1f}")
                thamnien_entryct.insert(0,f"{float(values[4]):.1f}")
                phunu_entryct.insert(0,f"{float(values[5]):.1f}")
                chuyencan_entryct.insert(0,f"{float(values[6]):.1f}")
                khenthuong_entryct.insert(0,f"{float(values[7]):.1f}")
                tongkhautru_entryct.insert(0,f"{float(values[8])+float(values[9])+float(values[10])+\
                                                float(values[11])+float(values[12])+float(values[13]):.1f}")
                thue_entryct.insert(0,f"{float(values[8]):.1f}")
                bhyt_entryct.insert(0,f"{float(values[9]):.1f}")
                bhxh_entryct.insert(0,f"{float(values[10]):.1f}")
                bhtn_entryct.insert(0,f"{float(values[11]):.1f}")
                congdoan_entryct.insert(0,f"{float(values[12]):.1f}")
                khac_entryct.insert(0,f"{float(values[13]):.1f}")
    ...
    frameTaiKhoan.place(x = 150,y=80)
